 ...
 *
 * @param {MergeFileResult} out The git_merge_file_result to be filled in
 ...
 */
// Merge.file = function(out, ancestor, ours, theirs, options) {
//   return _file.call(this, out, ancestor, ours, theirs, options);
// }
